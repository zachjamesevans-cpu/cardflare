 ...
 * given. The lock on the owner-only pages is server-side too, in
 * `loadStoreConsole`, so a hidden tab is never the only thing keeping
 * an organizer out of billing.
 */
export type StoreTabId =
  "overview" | "event-hub" | "events" | "singles" | "organizers" | "settings";

 ...
 *
 * NO SERVER-ONLY IMPORTS HERE. Both clients read this to decide what to
 * draw, and the app bundles it; the reads and writes live next door in
 * `view-settings.ts` where the admin client is allowed.
 */

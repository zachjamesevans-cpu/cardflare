...
export type TradeRow = {
  ...
  quantity: number;
  confirmed_at: string;
  /** When the named partner said yes. Null until they do. */
  acknowledged_at: string | null;
  /** When the payout was decided, whatever the amount. */
  paid_at: string | null;
...
export type PlayerRow = {
  ...
  /** Lifetime Embers taken back by disputes. The badge is earned minus this. */
  embers_reversed: number;
  /** Generated by the database: embers_earned minus embers_reversed. */
  embers_badge: number;
  /**
...
export type EmberReason = "trade" | "purchase" | "grant" | "attendance" | "reversal";

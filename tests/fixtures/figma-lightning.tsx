const CX = 200, CY = 200, RING_R = 152;
...
export default function App() {
  return (
    <div className="size-full flex items-center justify-center bg-[#04040c]">
      <style>{`
        @keyframes lf-a {
          0%,100%{opacity:1}
          46%{opacity:.07}
      ...
      <svg width="400" height="400" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Page background */}
        <circle cx={CX} cy={CY} r={200} fill="url(#page-bg)" />
        ...
        {/* Profile circle fill — covers spark start points */}
        <circle cx={CX} cy={CY} r={RING_R - 4} fill="url(#profile-fill)" />

        {/* Person silhouette placeholder */}
        <circle cx={CX} cy={CY - 24} r={40} fill="#252566" opacity={0.55} />
        <path
          d={`M${CX - 62},${CY + 78} C${CX - 55},${CY + 30} ${CX - 20},${CY + 18} ${CX},${CY + 18} C${CX + 20},${CY + 18} ${CX + 55},${CY + 30} ${CX + 62},${CY + 78}`}
          fill="#252566"
          opacity={0.55}
        />
